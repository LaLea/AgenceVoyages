...
public class FabriqueLigne {
	...
	/**
	 * cr�e la Ligne dans la base de donn�es si elle n'existe pas d�j� dans la fabrique, et la BDD 
	...
	/**
	 * permet de supprimer une ligne grace � l'id de la ligne
	 * @param id_Ligne l'id de la ligne � supprimer
	 */
	...
	/**
	 * permet de recuperer les lignes grace � la ville de d�part et la ville d'arriv�e
	 * @param id_ville l'id de la ville de d�part
	 * @param id_ville2 l'id de la ville d'arriv�e
	 * @return la liste des lignes qui correspondent � ces 2 villes
	 */
	...
	/**
	 * permet de recuperer l'id d'une ligne grace � la ville de depart et celle d'arrivee
	 * @param idDepart l'id de la ville de depart
	 * @param idArrivee l'id de la ville d'arrivee
	 * @return l'id de la ligne qui correspond � ces villes
	 */
